<%@ Page Title="" Language="C#" MasterPageFile="~/Views/NavbarMaster.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="RAiso.Views.Details1" %>
    ...
    <div class="content">
        <div class="box">
            ...
            <div class="view-stationery">
                ...
                <div ID="divQuantity" runat="server" class="stationery-quantity" visible="false">
