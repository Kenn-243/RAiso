<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DetailsAdmin.aspx.cs" Inherits="RAiso.Views.Admin.DetailsAdmin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../../Styles/DetailsAdmin.css" rel="stylesheet" type="text/css" />
</asp:Content>
    ...
    <div class="content">
        <div class="box">
            ...
            <div class="view-details-guest">
                <asp:GridView ID="gvDetailsAdmin" runat="server" AutoGenerateColumns="False" >
                    <Columns>
